...
interesting failures live BETWEEN them. "awflow is installed" is not the useful
fact -- "awflow is installed and the thing it pairs with is not" is. This reports
...
SELF = 'awflow'
FAMILY = ['awask', 'awavatar', 'awbac', 'awbrain', 'awbrowse', 'awclassify', 'awdelphi', 'awdit', 'awembed', 'awevolve', 'awfind', 'awfocus', 'awgit', 'awgraph', 'awgym', 'awiam', 'awkno', 'awm', 'awmail', 'awnboard', 'awnest', 'awnet', 'awnode', 'awpredict', 'awprism', 'awprove', 'awreason', 'awrecover', 'awrecurse', 'awrelay', 'awrena', 'awrepl', 'awresearch', 'awrise', 'awrouter', 'awrtifact', 'awrun', 'awscreen', 'awseal', 'awsettings', 'awshare', 'awstorage', 'awswarm', 'awtax', 'awtoll', 'awtunnel', 'awvision', 'awvoice', 'awwall', 'gawbbonet']
PAIRS_WITH = ['awask', 'adk', 'awgraph', 'awm', 'awrelay', 'awrun']
...
#: gets ignored.
ENV_REQUIRED = []
ENV_OPTIONAL = ['AWFLOW_JOURNAL_ROOT']
...
def _local_checks() -> "list[str]":
    ...
    from the registry, but it does not know what awflow needs at runtime, and a
